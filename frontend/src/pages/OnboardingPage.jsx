...
const MOVIE_POOL = {
  ...
  scifi: [
    ...
    { id: 157336, title: 'Interstellar', year: 2014, genre: 'Sci-Fi', director: 'Christopher Nolan', cast: ['Matthew McConaughey', 'Anne Hathaway', 'Jessica Chastain'], rating: 8.6, poster: 'https://image.tmdb.org/t/p/w500/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg', description: "A team of explorers travel through a wormhole in space in an attempt to ensure humanity's survival." },
  ...
  thriller: [
    ...
    { id: 1949,  title: 'Zodiac', year: 2007, genre: 'Thriller', director: 'David Fincher', cast: ['Jake Gyllenhaal', 'Mark Ruffalo', 'Robert Downey Jr.'], rating: 7.5, poster: 'https://image.tmdb.org/t/p/w500/6YmeO4pB7XTh8P8F960O1uA14JO.jpg', description: 'A San Francisco cartoonist becomes an amateur detective obsessed with the Zodiac killer.' },
    { id: 77338, title: 'The Intouchables', year: 2011, genre: 'Thriller', director: 'Olivier Nakache', cast: ['Francois Cluzet', 'Omar Sy', 'Anne Le Ny'], rating: 8.5, poster: 'https://image.tmdb.org/t/p/w500/1QU7HKgsQbGpzsJbJK4pAVQV9F5.jpg', description: 'After a paragliding accident, a rich man hires a young man from the projects as his caretaker.' },
  ],
  drama: [
    ...
    { id: 238,  title: 'The Godfather', year: 1972, genre: 'Drama', director: 'Francis Ford Coppola', cast: ['Marlon Brando', 'Al Pacino', 'James Caan'], rating: 9.2, poster: 'https://image.tmdb.org/t/p/w500/3bhkrj58Vtu7enYsRolD1fZdja1.jpg', description: 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.' },
  ...
  crime: [
    ...
    { id: 598,    title: 'City of God', year: 2002, genre: 'Crime', director: 'Fernando Meirelles', cast: ['Alexandre Rodrigues', 'Leandro Firmino', 'Phellipe Haagensen'], rating: 8.6, poster: 'https://image.tmdb.org/t/p/w500/k7eYdWvhYQyRQoU2TB2A2Xu2TfD.jpg', description: 'Two boys growing up in a dangerous neighborhood of Rio de Janeiro take different paths.' },
  ...
  adventure: [
    ...
    { id: 37724, title: 'Skyfall', year: 2012, genre: 'Adventure', director: 'Sam Mendes', cast: ['Daniel Craig', 'Javier Bardem', 'Judi Dench'], rating: 7.8, poster: 'https://image.tmdb.org/t/p/w500/d0IVecFQvsGdSbnMAHqiYsNYaJT.jpg', description: "Bond's loyalty to M is tested as her past comes back to haunt her." },
    { id: 9806,  title: 'The Incredibles', year: 2004, genre: 'Adventure', director: 'Brad Bird', cast: ['Craig T. Nelson', 'Holly Hunter', 'Samuel L. Jackson'], rating: 8.0, poster: 'https://image.tmdb.org/t/p/w500/2LqaLgk4Z226KkgPJuiOQ58wvrm.jpg', description: 'A family of undercover superheroes tries to live a quiet suburban life but is forced to save the world.' },
  ],
  fantasy: [
    ...
    { id: 284053, title: 'Thor: Ragnarok', year: 2017, genre: 'Fantasy', director: 'Taika Waititi', cast: ['Chris Hemsworth', 'Tom Hiddleston', 'Cate Blanchett'], rating: 7.9, poster: 'https://image.tmdb.org/t/p/w500/rzRwTcFvttcN1ZpX2xv4j3tSdJu.jpg', description: 'Imprisoned on Sakaar, Thor must race against time to return to Asgard and stop Ragnarok.' },
    { id: 1417,   title: "Pan's Labyrinth", year: 2006, genre: 'Fantasy', director: 'Guillermo del Toro', cast: ['Ivana Baquero', 'Ariadna Gil', 'Doug Jones'], rating: 8.2, poster: 'https://image.tmdb.org/t/p/w500/z7xXihu5wHuSMWymq5VAulPVuvg.jpg', description: 'In fascist Spain, a bookish young stepdaughter escapes into a labyrinthine fantasy world.' },
  ...
  war: [
    ...
    { id: 530915, title: '1917', year: 2019, genre: 'War', director: 'Sam Mendes', cast: ['George MacKay', 'Dean-Charles Chapman', 'Mark Strong'], rating: 8.3, poster: 'https://image.tmdb.org/t/p/w500/iZf0KyrE25z1sage4SYFLCCrMi9.jpg', description: 'Two British soldiers are sent on a dangerous mission to deliver a message that could save 1,600 lives.' },
    ...
    { id: 600,    title: 'Full Metal Jacket', year: 1987, genre: 'War', director: 'Stanley Kubrick', cast: ['Matthew Modine', 'R. Lee Ermey', "Vincent D'Onofrio"], rating: 8.0, poster: 'https://image.tmdb.org/t/p/w500/kMKyx1k8hWWscYFnPbnxxN4Eqo4.jpg', description: 'A two-segment look at the brutality of war: boot camp and Vietnam combat.' },
